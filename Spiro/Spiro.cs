...
namespace SpiroNet
{
    public static class Spiro
    {
        ...
        private static int IsFinite(double x)
        {
        ...
        private static void integrate_spiro(double[] ks, double[] xy, int n)
        {
            double th1 = ks[0];
            double th2 = 0.5 * ks[1];
        ...
        private static double compute_ends(double[] ks, double[][] ends, double seg_ch)
        {
        ...
        private static void compute_pderivs(ref SpiroSegment s, double[][] ends, double[][][] derivs, int jinc)
        {
            double recip_d = 2e6;
        ...
        private static double mod_2pi(double th)
        {
            double u = th / (2 * Math.PI);
            return 2 * Math.PI * (u - Math.Floor(u + 0.5));
        }

        private static SpiroSegment[] setup_path(SpiroControlPoint[] src, int n)
        {
            int i, ilast, n_seg;
            double dx, dy;
            SpiroSegment[] r;
        ...
        private static void bandec11(BandMatrix[] m, int[] perm, int n)
        {
            int i, j, k, l, pivot;
        ...
        private static void banbks11(BandMatrix[] m, int[] perm, double[] v, int n)
        {
            int i, k, l;
            double tmp, x;
        ...
        private static int compute_jinc(SpiroPointType ty0, SpiroPointType ty1)
        {
        ...
        private static int count_vec(SpiroSegment[] s, int nseg)
        {
            int i, n;
        ...
        private static void add_mat_line(BandMatrix[] m, double[] v, double[] derivs, double x, double y, int j, int jj, int jinc, int nmat)
        {
            int joff, k;
        ...
        private static double spiro_iter(SpiroSegment[] s, BandMatrix[] m, int[] perm, double[] v, int n, int nmat)
        {
            bool cyclic;
        ...
        private static bool check_finiteness(SpiroSegment[] segs, int num_segs)
        {
            int i, j;
        ...
        private static int solve_spiro(SpiroSegment[] s, int nseg)
        {
        ...
        private static void spiro_seg_to_bpath(double[] ks, double x0, double y0, double x1, double y1, IBezierContext bc, int depth)
        {
        ...
        private static SpiroSegment[] run_spiro(SpiroControlPoint[] src, int n)
        {
            int converged, nseg;
            SpiroSegment[] s;
        ...
        private static void spiro_to_bpath(SpiroSegment[] s, int n, IBezierContext bc)
        {
            int i, nsegs;
            double x0, y0, x1, y1;
        ...
        private static double get_knot_th(SpiroSegment[] s, int i)
        {
            double[][] ends = { new double[4], new double[4] };
